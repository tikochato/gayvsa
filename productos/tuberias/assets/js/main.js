...
var main = (function($) { var _ = {
	...
	initEvents: function() {
		...
		// Window.
			...
			// Remove is-preload-* classes on load.
				_.$window.on('load', function() {
					...
					_.$carrousel.removeClass('is-preload-0');

					window.setTimeout(function() {
						_.$carrousel.removeClass('is-preload-1');
					}, 100);

					window.setTimeout(function() {
						_.$carrousel.removeClass('is-preload-2');
			...
			// Disable animations/transitions on resize.
				...
				_.$window.on('resize', function() {
					...
					_.$carrousel.addClass('is-preload-0');
		...
		// Keyboard shortcuts.
			...
			// Ignore shortcuts within form elements.
				_.$carrousel.on('keydown', 'input,select,textarea', function(event) {
					event.stopPropagation();
				});
	...
	up: function() {
		...
		// Fullscreen? Bail.
			if (_.$carrousel.hasClass('fullscreen'))
				return;
	...
	show: function() {
		...
		// Show main wrapper.
			_.$carrousel.removeClass('fullscreen');
	...
	hide: function() {
		...
		// Hide main wrapper.
			_.$carrousel.addClass('fullscreen');
